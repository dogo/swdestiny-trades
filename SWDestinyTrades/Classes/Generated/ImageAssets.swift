...
internal enum Asset {
    ...
    internal static let icBlank = ImageAsset(name: "ic_blank")
    internal static let icDiscard = ImageAsset(name: "ic_discard")
    internal static let icDisrupt = ImageAsset(name: "ic_disrupt")
    internal static let icFocus = ImageAsset(name: "ic_focus")
    internal static let icIndirect = ImageAsset(name: "ic_indirect")
    internal static let icMelee = ImageAsset(name: "ic_melee")
    internal static let icRanged = ImageAsset(name: "ic_ranged")
    internal static let icResource = ImageAsset(name: "ic_resource")
    internal static let icShield = ImageAsset(name: "ic_shield")
    internal static let icSpecial = ImageAsset(name: "ic_special")
    internal enum Logo {
