...
internal enum Asset {
  ...
  internal static let appTheme = ColorAsset(name: "AppTheme")
  internal static let appThemeForeground = ColorAsset(name: "AppThemeForeground")
  internal static let appThemeSecondary = ColorAsset(name: "AppThemeSecondary")
  internal enum Logo {
  ...
  internal static let paletteBlue = ColorAsset(name: "PaletteBlue")
  internal static let paletteGray = ColorAsset(name: "PaletteGray")
  internal static let paletteLightGray = ColorAsset(name: "PaletteLightGray")
  internal static let paletteRed = ColorAsset(name: "PaletteRed")
  internal static let paletteYellow = ColorAsset(name: "PaletteYellow")
  internal enum Sets {
